...
<div id="main_bg2">
  ...
  <p></p>
  <p>｜<a href="index.php" title="群馬県館林市のガールズバー「Girls Bar WaiWai合衆国」">トップページ</a> ＞＞ <strong>店舗情報</strong></p></div>
  <div id="hoka_main">
    <div id="left"><?php include ('php/left.php'); ?></div>
    <div id="right"><img src="img/shoppage.jpg" width="790" height="129" /></div>
    <div id="clear"></div>
  </div>
