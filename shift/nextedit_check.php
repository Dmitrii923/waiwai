...
<h1><?php print $next_month; ?>月のイベントスケジュール登録確認</h1>
...
<?php
 ...
 //見出し部分出力
 echo "<tr><td colspan=\"2\"><div>".$now_year.'年'.$next_month."月のイベントスケジュール</div></td></tr>\n";
 ...
 <form action="nextedit_write.php" method="post">
