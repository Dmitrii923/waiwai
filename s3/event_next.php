...
else{echo $now_year;} ?>年<?php print $next_month; ?>月の月間イベント｜群馬県館林市のガールズバー「WaiWai合衆国」スマホ版</title>
<meta name="description" content="群馬県館林市のガールズバー「WaiWai合衆国」のスマホ版<?php if($now_month=='12'){echo $next_year;}
else{echo $now_year;} ?>年<?php print $next_month; ?>月のイベントページです。群馬県館林市で遊ぶ・飲む・働くならガールズバー「WaiWai合衆国」で決まり!!">
...
<header id="top">
  ...
  <p><a href="index.php" title="館林 ガールズバー「WaiWai合衆国」">ホーム</a> >> <strong><?php if($now_month=='12'){echo $next_year;}
else{echo $now_year;} ?>年<?php print $next_month; ?>月のイベント</strong></p>
</header>

<h2 class="heading"><?php if($now_month=='12'){echo $next_year;}
else{echo $now_year;} ?>年<?php print $next_month; ?>月のイベント　<span id="hd">Event Info</span></h2>
<div id="wrap">

<div id="shop_event">
  <div class="event_next">
  <a href="event.php?id=<?php print $now_year; ?><?php print $now_month; ?>"><?php print $now_month; ?>月のイベント ＞＞</a>
  </div>
  <table class="event_t">
    <?php
