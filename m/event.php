...
<title><?php print $now_year; ?>年<?php print $now_month; ?>月の月間イベント｜群馬県館林市のガールズバー「WaiWai合衆国」モバイル版</title>
...
<table width="240" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <font color="#FFFFFF" size="2">■EVENT　<font size="1"><?php print $now_year; ?>年<?php print $now_month; ?>月｜月間イベント</font></font>
    </td>
  </tr>
  </table>
<br />
...
else{echo $now_year;} ?><?php print $next_month; ?>">&gt;&gt;<?php print $next_month; ?>月のイベントスケジュール</a>
    </font>
    </td>
  </tr>
  </table>
