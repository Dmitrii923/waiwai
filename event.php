...
<title><?php print $now_year; ?>年<?php print $now_month; ?>月の月間イベント</title>
...
<div id="main_bg2">
  ...
  <p></p>
  <p>｜<a href="index.php" title="群馬県館林市のガールズバー「Girls Bar WaiWai合衆国」">トップページ</a> ＞＞ <strong><?php print $now_year; ?>年<?php print $now_month; ?>月の月間イベント</strong></p></div>
  <div id="hoka_main">
    <div id="left"><?php include ('php/left.php'); ?></div>
    <div id="right"><img src="img/eventpage.jpg" width="790" height="129" /><div id="event_naka"><div class="box"><?php print $now_year; ?>年<?php print $now_month; ?>月のイベントスケジュール</div>
    <div id="event_next"><a href="event_next.php?id=<?php if($now_month=='12'){echo $next_year;}
else{echo $now_year;} ?><?php print $next_month; ?>">&gt;&gt;<?php print $next_month; ?>月のイベントスケジュール</a></div>
<div id="clear"></div>
      <table cellspacing="0">
  <?php
